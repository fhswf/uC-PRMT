...
/**
 @file vl53l0x.h
 @code #include "zumo/vl53l0x.h" @endcode

 @brief Low-Level Routinen um die ToF-Sensoren anzusprechen
*/
...
// ================================================-
// ProtoType
uint8_t  VL53L0Xm_init(uint8_t addr, uint8_t io_2v8 );
void VL53L0Xm_startContinuous(uint8_t addr, uint32_t period_ms );
void VL53L0Xm_stopContinuous(uint8_t addr);
uint16_t VL53L0Xm_readRangeContinuousMillimeters(uint8_t addr);
uint16_t VL53L0Xm_readRangeSingleMillimeters(uint8_t addr);
uint8_t VL53L0X_pingAddress(uint8_t addr);


uint8_t VL53L0X_init_single(uint8_t addr);
uint8_t VL53L0X_start_single(uint8_t addr);
...
void 	 VL53L0X_startSingle(uint8_t addr);
...
#else
extern volatile uint32_t timeout_start_ms ;	// Observed variable of elapsed time

extern uint32_t VL53L0X_address;
extern uint16_t io_timeout;	// Timeout Observation 1
extern uint8_t did_timeout;
