 ...
 * @file testing.c
 *
 * @brief Testfunktionen zum �berpr�fen der Hardware
 *
 *
 */


#define BTN_OK 0x01    ///< Merker fuer OK Button (Binary)
#define BTN_DN 0x02	   ///< Merker fuer Down Button (Binary)
#define BTN_UP 0x04    ///< Merker fuer Up Button (Binary)
#define BTN_USR 0x08   ///< Merker fuer User Button (Binary)
#define BTN_WAIT 1	   ///< in buttonpressed warten, bis Taste gedrueckt
#define BTN_NOWAIT 0   ///< in buttonpressed nicht warten, nur abfragen

extern I2C_HandleTypeDef hi2c1;		///< Handle fuer I2C Bus, bei scan_i2c benoetigt
...
/***************************************************************************/
/**
 * @brief Das Menue f�r die Testroutinen ausgeben
 *
 * @param none
 * @return none
 *
...
static void test_motors()
{
	...
	while (!done)
	{
		...
		// Warten, w�hrend dessen aber Taster abfragen...
		for(i=0;i<20;i++)
		{
...
/***************************************************************************/
/**
 *  @brief Alle aktiven Komponenten am I2C-Bus listen; ausgabe �ber USB/seriell
 *
 *	@param none
 *	@return none
 */
 ...
 *
 * @param wait
 * 		BTN_NOWAIT -> Nicht warten, 0 zur�ckgeben wenn kein Taster gedr�ckt
 *      BTN_WAIT   -> Warten, bis ein Taster gedr�ckt wurde
 *
 * @return
 *      0 -> Kein Taster
...
/**
 * @brief Zeichne Zumo K�rper f�r ToF-Anzeige
 */
static void testing_draw_body()
{
